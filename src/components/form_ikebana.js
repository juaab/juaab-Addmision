                ...
                <div className="container">
                    <div className="form-item">
                        ...
                        <form role="form" onSubmit={this.handleSubmit}>
                            ...
                            <div className="form-group">
                                <label htmlFor="number">Contact info:</label><br />

                                <label htmlFor="tel">Tel:</label>
                                <input type="text" name="tel" id="tnumbervarl" placeholder="Tel" onChange={this.handleChange} />

                                <label htmlFor="cell">Cell:</label>
                                <input type="text" name="cell" id="cnumberval" placeholder="Cell" onChange={this.handleChange} required="required" />
                            ...
                            <div className="form-group">
                                ...
                                <input type="address" className="form-control" id="peraddval" name="p_address" onChange={this.handleChange} required="required" />
                            </div><hr></hr>
